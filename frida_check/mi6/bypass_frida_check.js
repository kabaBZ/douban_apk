...
function hook_JNI_OnLoad(){  // 这个写的好像有问题 一直hook不到
...
function hook_linker_call_constructors() {
    let call_constructors = Module.getBaseAddress('linker64').add(0x2FAC4)  // __dl__ZN6soinfo17call_constructorsEv  linker64偏移量可以在ida找到
